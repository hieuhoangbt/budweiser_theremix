        ...
        <div id="j-main-container">
            ...
            <table class="table table-striped" id="frameList">
                ...
                <tr>
                    ...
                    <th class='left'>
                        <?php echo JHtml::_('grid.sort', 'COM_BUDWEISER_THEREMIX_FRAMES_CELEBRITY_ID', 'a.`celebrity_id`', $listDirn, $listOrder); ?>
                    </th>
                    <th class='left'>
                        <?php echo JHtml::_('grid.sort', 'COM_BUDWEISER_THEREMIX_FRAMES_USER_ID', 'a.`user_id`', $listDirn, $listOrder); ?>
                    </th>
                    <th class='left'>
                        <?php echo JHtml::_('grid.sort', 'COM_BUDWEISER_THEREMIX_FRAMES_IMAGE', 'a.`image`', $listDirn, $listOrder); ?>
                    </th>
                    <th class='left'>
                        <?php echo JHtml::_('grid.sort', 'COM_BUDWEISER_THEREMIX_FRAMES_CREATED_AT', 'a.`created_at`', $listDirn, $listOrder); ?>
                    </th>
                    <th class='left'>
                        <?php echo JHtml::_('grid.sort', 'COM_BUDWEISER_THEREMIX_FRAMES_UPDATED_AT', 'a.`updated_at`', $listDirn, $listOrder); ?>
                    </th>
                ...
                <?php foreach ($this->items as $i => $item) :
                    ...
                    <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <td>
                            <?php $celebrity=Budweiser_theremixHelper::getCelebrityFromId($item->celebrity_id); ?>
                            <?php echo (!empty($celebrity))?$celebrity:""; ?>
                        </td>
                        <td>
