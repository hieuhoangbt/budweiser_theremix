 ...
 * @since  1.6
 */
class Budweiser_theremixViewUsers extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		Budweiser_theremixHelpersBudweiser_theremix::addSubmenu('users');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_BUDWEISER_THEREMIX_TITLE_USERS'), 'users.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_budweiser_theremix&view=users');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`fullname`' => JText::_('COM_BUDWEISER_THEREMIX_USERS_FULLNAME'),
			'a.`name_image`' => JText::_('COM_BUDWEISER_THEREMIX_USERS_NAME_IMAGE'),
			'a.`scope_id`' => JText::_('COM_BUDWEISER_THEREMIX_USERS_SCOPE_ID'),
			'a.`gender`' => JText::_('COM_BUDWEISER_THEREMIX_USERS_GENDER'),
			'a.`email`' => JText::_('COM_BUDWEISER_THEREMIX_USERS_EMAIL'),
			'a.`created_at`' => JText::_('COM_BUDWEISER_THEREMIX_USERS_CREATED_AT'),
			'a.`updated_at`' => JText::_('COM_BUDWEISER_THEREMIX_USERS_UPDATED_AT'),
		);
	}
}
