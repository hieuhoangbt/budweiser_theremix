...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_budweiser_theremix&task=users.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_budweiser_theremix&view=users'); ?>" method="post"
			...
			<table class="table table-striped" id="userList">
				...
				<tr>
					...
					<?php endif; ?>
									...
									<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_BUDWEISER_THEREMIX_USERS_ID', 'a.`id`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_BUDWEISER_THEREMIX_USERS_FULLNAME', 'a.`fullname`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_BUDWEISER_THEREMIX_USERS_NAME_IMAGE', 'a.`name_image`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_BUDWEISER_THEREMIX_USERS_SCOPE_ID', 'a.`scope_id`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_BUDWEISER_THEREMIX_USERS_GENDER', 'a.`gender`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_BUDWEISER_THEREMIX_USERS_EMAIL', 'a.`email`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_BUDWEISER_THEREMIX_USERS_CREATED_AT', 'a.`created_at`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_BUDWEISER_THEREMIX_USERS_UPDATED_AT', 'a.`updated_at`', $listDirn, $listOrder); ?>
				</th>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_budweiser_theremix&task=user.edit&id='.(int) $item->id); ?>">
