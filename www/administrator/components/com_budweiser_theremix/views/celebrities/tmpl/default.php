...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_budweiser_theremix&task=celebrities.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'celebrityList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<form action="<?php echo JRoute::_('index.php?option=com_budweiser_theremix&view=celebrities'); ?>" method="post"
			...
			<table class="table table-striped" id="celebrityList">
				...
				<tr>
					...
					<?php endif; ?>
									...
									<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_BUDWEISER_THEREMIX_CELEBRITIES_ID', 'a.`id`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_BUDWEISER_THEREMIX_CELEBRITIES_NAME', 'a.`name`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'Image jpeg', 'a.`image_jpeg`', $listDirn, $listOrder); ?>
				</th>
                                <th class='left'>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_BUDWEISER_THEREMIX_CELEBRITIES_UPDATED_AT', 'a.`updated_at`', $listDirn, $listOrder); ?>
				</th>
				...
				<?php foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<?php if (isset($this->items[0]->state)): ?>
							<td class="center">
								<?php echo JHtml::_('jgrid.published', $item->state, $i, 'celebrities.', $canChange, 'cb'); ?>
</td>
						<?php endif; ?>
				...
				<?php if (isset($item->checked_out) && $item->checked_out && ($canEdit || $canChange)) : ?>
					<?php echo JHtml::_('jgrid.checkedout', $i, $item->uEditor, $item->checked_out_time, 'celebrities.', $canCheckin); ?>
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_budweiser_theremix&task=celebrity.edit&id='.(int) $item->id); ?>">
				...
				<?php endif; ?>
					...
					<img src="<?php echo JUri::root() . $this->escape($item->image_jpeg); ?>" width="100" height="100" ?>
				</td>
                                <td>
