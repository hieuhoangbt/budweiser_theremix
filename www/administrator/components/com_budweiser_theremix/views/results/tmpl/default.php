    ...
    <?php if (isset($this->items[0]->ordering)) : ?>
                            ...
                            <td>
                                <a href="<?php echo JRoute::_('index.php?option=com_budweiser_theremix&task=result.edit&id=' . (int) $item->id); ?>">
                                    <img src="<?php echo JUri::root() . $this->escape($item->image); ?>" width="100" height="100" ></a>
                            ...
                            <td>
                                ...
                                <?php $frame=  Budweiser_theremixHelper::getFrameNameFromId($item->celebrity_id); ?>
                                <?php echo (!empty($frame))?$frame:""; ?>
                            </td>
