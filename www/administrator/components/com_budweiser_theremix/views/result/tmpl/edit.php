...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="result-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_BUDWEISER_THEREMIX_TITLE_RESULT', true)); ?>
		<div class="row-fluid">
			<div class="span10 form-horizontal">
				...
				<?php echo $this->form->renderField('celebrity_id'); ?>
				<?php echo $this->form->renderField('frame_id'); ?>
