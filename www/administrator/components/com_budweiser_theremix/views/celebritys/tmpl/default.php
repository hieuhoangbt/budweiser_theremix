...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_budweiser_theremix&task=celebritys.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_budweiser_theremix&view=celebritys'); ?>" method="post"
        ...
        <div id="j-main-container">
            ...
            <table class="table table-striped" id="celebrityList">
                ...
                <tr>
                    ...
                    <th class='left'>
                        <?php echo JHtml::_('grid.sort', 'COM_BUDWEISER_THEREMIX_CELEBRITYS_ID', 'a.`id`', $listDirn, $listOrder); ?>
                    </th>
                    <th class='left'>
                        <?php echo JHtml::_('grid.sort', 'COM_BUDWEISER_THEREMIX_CELEBRITYS_NAME', 'a.`name`', $listDirn, $listOrder); ?>
                    </th>
                    <th class='left'>
                        <?php echo JHtml::_('grid.sort', 'COM_BUDWEISER_THEREMIX_CELEBRITYS_IMAGE', 'a.`image`', $listDirn, $listOrder); ?>
                    </th>
                ...
                <?php foreach ($this->items as $i => $item) :
                    ...
                    <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <?php if (isset($this->items[0]->state)): ?>
                            <td class="center">
                                <?php echo JHtml::_('jgrid.published', $item->state, $i, 'celebritys.', $canChange, 'cb'); ?>
                            </td>
                        <?php endif; ?>
                        ...
                        <td>
                            <?php if (isset($item->checked_out) && $item->checked_out && ($canEdit || $canChange)) : ?>
                                <?php echo JHtml::_('jgrid.checkedout', $i, $item->uEditor, $item->checked_out_time, 'celebritys.', $canCheckin); ?>
                            <?php endif; ?>
                            <?php if ($canEdit) : ?>
