...
<form
	...
	<div class="form-horizontal">
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_BUDWEISER_THEREMIX_TITLE_USER', true)); ?>
		<div class="row-fluid">
			<div class="span10 form-horizontal">
				...
				<?php echo $this->form->renderField('modified_by'); ?>				<?php echo $this->form->renderField('fullname'); ?>
				<?php echo $this->form->renderField('name_image'); ?>
				<?php echo $this->form->renderField('scope_id'); ?>
