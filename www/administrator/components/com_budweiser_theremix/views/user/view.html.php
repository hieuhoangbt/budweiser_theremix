 ...
 * @since  1.6
 */
class Budweiser_theremixViewUser extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_BUDWEISER_THEREMIX_TITLE_USER'), 'user.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_budweiser_theremix.user', $this->item->id);
		}
