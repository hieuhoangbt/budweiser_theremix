 ...
 * @since  1.6
 */
class Budweiser_theremixControllerUsers extends JControllerAdmin
{
	/**
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_budweiser_theremix&view=users');
	}
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'user', $prefix = 'Budweiser_theremixModel', $config = array())
	{
